// --- GLOBAL PERSISTENT DARK MODE ---
(function() {
    const theme = localStorage.getItem('mmh_theme');
    const isDark = theme === 'dark';

    // 1. Create and Inject Global Dark Mode Styles
    ...
    style.innerHTML = `
        ...
        .dark-mode {
            ...
            --border-main: #334155 !important;
        }

        /* Apply variables to ALL pages automatically */
        body.dark-mode {
            background-color: var(--bg-main) !important;
            color: var(--text-main) !important;
        }

        /* Target common elements found in your folders (Quiz cards, headers, sidebars) */
        ...
        body.dark-mode p, body.dark-mode span, body.dark-mode h1, 
        body.dark-mode h2, body.dark-mode h3, body.dark-mode h4, 
        body.dark-mode h5, body.dark-mode h6 {
            color: var(--text-main) !important;
        }
        
        body.dark-mode .text-muted, body.dark-mode p.small {
            color: var(--text-muted) !important;
        }
    `;
    document.head.appendChild(style);

    // 2. Immediate Application to prevent "White Flash"
    if (isDark) {
...
// Define the toggle function globally so it can be called from index.html
window.toggleTheme = function() {
    const isDark = document.body.classList.toggle('dark-mode');
    document.documentElement.classList.toggle('dark-mode');
    localStorage.setItem('mmh_theme', isDark ? 'dark' : 'light');
    
    // Sync the checkbox if it exists on the page
